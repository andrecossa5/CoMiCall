...
def parse_args():
    ...
    p.add_argument('--max_strand_ratio',         type=float, default=10)
    p.add_argument('--af_threshold',             type=float, default=0.01)
    p.add_argument('--min_callable_coverage',    type=float, default=10)
    p.add_argument('--max_sb_pval',              type=float, default=0.05)
    p.add_argument('--max_prevalence_low_AF',    type=float, default=0.2)
